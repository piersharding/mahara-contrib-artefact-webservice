...
$heading = get_string('webservices_title', 'artefact.webservice');
$smarty->assign('PAGEHEADING', $heading);
$smarty->display('form.tpl');

function webserviceconfig_submit(Pieform $form, $values) {

}

function webserviceconfig_validate(PieForm $form, $values) {
...
//     redirect('/artefact/webservice/index.php?plugintype=artefact&pluginname=webservice&type=webservice');
// }
